...
Template-bsed hand pose recognition using multiple clues \cite{Stenger2006}
...
human detection with HOG \cite{NavneetDalal2006}
SIFT, SURF \& seasons \cite{Valgren2010}
Pedestrian detection with HOG \cite{watanabe2009}


\paragraph{Others}
the kod\'{a}ly method: \cite{choksy1999}
Clustering and contour extraction \cite{Suzuki1985}
Robust Real-Time Face detection \cite{Viola2004}
