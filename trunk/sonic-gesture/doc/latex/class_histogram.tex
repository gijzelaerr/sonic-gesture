...
\begin{DoxyCompactList}\small\item\em Class that encapsulates the opencv histogram. \item\end{DoxyCompactList}\item 
...
Class that encapsulates the opencv histogram. 

The combiner class combines a vector of frames into one big frame. \hypertarget{class_histogram_aaf22daf3b8e3f0578337109005532f51}{
...
\subsubsection[{backproject}]{\setlength{\rightskip}{0pt plus 5cm}Mat Histogram::backproject (
\begin{DoxyParamCaption}
...
\subsubsection[{update}]{\setlength{\rightskip}{0pt plus 5cm}void Histogram::update (
\begin{DoxyParamCaption}
\item[{const Mat \&}]{ image}
\end{DoxyParamCaption}
)}}
