function [avgPrec clfsOutput]= SvmPKExpOpt(trainDist, testDist, trainLabels, testLabels, cRange, nReps, nFolds, verbose)
...
% Distance matrix will be taken to the exponent.
%
...
for i=1:size(trainLabels,2)
    ...
    w = svmcPKExpCrossVal(trainDist, trainL, cRange, nReps, nFolds);
