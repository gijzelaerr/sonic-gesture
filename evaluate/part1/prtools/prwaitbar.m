...
% PRWATBARINIT, PRWAITBARNEXT, PRWAITBARONCE, PREIG, PRINV, PRPINV, PRRANK,
% PRSVD, PRCOV
%
% SEE ALSO
% PRPROGRESS, PRWATBARINIT, PRWAITBARNEXT, PRWAITBARONCE
...
elseif nargin == 2
	...
	if isstr(m)                           % ---- call: prwaitbar(n,text) ----
		...
		if (~strcmp(err.message,'##') & ~strcmp(err.message,'')) | (~ishandle(WHANDLE))
