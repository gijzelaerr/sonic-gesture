...
\subfloat[Without stabilizer]{
	\includegraphics[width=0.7\linewidth]{figures/performance/anne1_unstable.jpg}}
\hspace{0.02\linewidth}
\subfloat[With stabilizer]{
	\includegraphics[width=0.7\linewidth]{figures/performance/anne1_stable.jpg}}
\hspace{0.02\linewidth}
\subfloat[Arbitrary movie with stabilizer]{
	\includegraphics[width=0.7\linewidth]{figures/performance/heilige.jpg}}
